...
?>
          ...
          <div class="row row-70 justify-content-md-center justify-content-xl-between">
            ...
            <div class="col-md-10 col-lg-6">
              <div class="row grid-2">
                <div class="col-6"><img src="images/10.jpg" alt="" width="273" height="214"/><img src="images/12.jpg" alt="" width="273" height="214"/>
                </div>
                <div class="col-6"><img src="images/11.jpg" alt="" width="273" height="451"/>
                </div>
              </div>
            </div>
          </div>
      ...
      <!-- Our History-->
      <section class="section parallax-container bg-gray-dark" data-parallax-img="images/23.jpg">
              ...
              <div class="timeline">
                <div class="timeline__item-wrap">
                  ...
                  <article class="timeline__item">
                    ...
                    <div class="timeline__item-main"><img src="images/13.jpg" alt="" width="93" height="86"/>
                ...
                <div class="timeline__item-wrap">
                  ...
                  <article class="timeline__item timeline__item-reverse">
                    ...
                    <div class="timeline__item-main"><img src="images/14.jpg" alt="" width="93" height="86"/>
                ...
                <div class="timeline__item-wrap">
                  ...
                  <article class="timeline__item">
                    ...
                    <div class="timeline__item-main"><img src="images/15.jpg" alt="" width="93" height="86"/>
          ...
          <div class="row row-50 justify-content-md-center justify-content-lg-start justify-content-xl-between">
            <div class="col-md-10 col-lg-6">
              ...
              <div class="group-3-columns" data-lightgallery="group">
                <div class="column-item"><a class="thumb-elegant" href="images/16.jpg" data-lightgallery="item"><img src="images/16.jpg" alt="" width="166" height="139"/>
                    <div class="thumb-elegant__overlay"></div></a></div>
                <div class="column-item"><a class="thumb-elegant" href="images/17.jpg" data-lightgallery="item"><img src="images/17.jpg" alt="" width="166" height="139"/>
                    <div class="thumb-elegant__overlay"></div></a></div>
                <div class="column-item"><a class="thumb-elegant" href="images/18.jpg" data-lightgallery="item"><img src="images/18.jpg" alt="" width="166" height="139"/>
                    <div class="thumb-elegant__overlay"></div></a></div>
              </div>
            </div>
