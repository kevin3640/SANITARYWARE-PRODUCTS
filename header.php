  ...
  <body>
    ...
    <div class="preloader" id="preloader">
      <div class="page-loader-logo">
        <div class="brand">
          <div class="brand__name"><img src="images/logo1.png" alt="" width="190" height="50"/>
          </div>
        </div>
      </div>
              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-panel">
                  ...
                  <div class="rd-navbar-brand"><a class="brand" href="index.php">
                      <div class="brand__name"><img src="images/logo1.png" alt="" width="190" height="90"/>
                      </div></a></div>
                </div>
                <!-- RD Navbar Nav-->
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-main-item"><a class="button button-xs button-lighter" href="login.php">Sign-up & Sign-in</a></div>
                  <!-- RD Navbar Nav-->
                  <ul class="rd-navbar-nav">
                    ...
                    <li><a href="typography.php">Products</a>
                    </li>
