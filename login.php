            ...
            <div class="row ">
                <div class="col-sm-10 login-box">
                    <div class="row">
                        <div class="col-lg-8 col-md-7 log-det">
                            ...
                            <div class="text-box-cont">
                                ...
                                <div class="input-group center mb-3" >
                                    <button class="btn btn-success btn-round"style="background-color:#F39B00">SIGN IN</button>
                                </div>    
                            </div>
                        ...
                        <div class="col-lg-4 col-md-5 box-de" style="background-color:#F39B00">
                            <div class="ditk-inf">
